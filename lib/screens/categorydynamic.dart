...
class CategoryDynamic extends StatefulWidget {
  ...
  @override
  _CategoryDynamicState createState() => _CategoryDynamicState();
}

class _CategoryDynamicState extends State<CategoryDynamic>
...
//                  height: 600,
  ...
  getcategory() async {
    var url = "https://api.sellship.co/api/category/" + widget.category;
    final response = await http.get(url);
    ...
    setState(() {
      ...
      tabcontrollerlength = subcategory.length;
    });
    ...
    getnotification();
    getfavourites();
    var subname = subcategorytabs[0].text;
